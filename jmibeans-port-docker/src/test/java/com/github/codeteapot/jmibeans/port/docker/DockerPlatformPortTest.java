...
class DockerPlatformPortTest {
  ...
  private static final String ANY_PROFILE_NAME_VALUE = "any-role";
  ...
  private static final String SOME_PROFILE_NAME_VALUE = "some-profile";
            ...
            .withBody(new JSONArray()
                .appendElement(new JSONObject()
                    ...
                    .appendField("Labels", new JSONObject()
                        .appendField("com.github.codeteapot.jmi.profile", SOME_PROFILE_NAME_VALUE))
        ...
        .willReturn(aResponse()
            ...
            .withBody(new JSONArray()
                .appendElement(new JSONObject()
                    ...
                    .appendField("State", "running")
                    .appendField("Labels", new JSONObject()
                        .appendField("com.github.codeteapot.jmi.profile", ANY_PROFILE_NAME_VALUE))
                    .appendField("NetworkSettings", new JSONObject()
                        .appendField("Networks", new JSONObject())))
                .toString())));
    stubFor(get(urlPathEqualTo("/containers/json"))
