...
setup_files_base_url="https://raw.githubusercontent.com/codeteapot/jmibeans/refs/heads"
setup_files_base_url="$setup_files_base_url/$git_branch_name"
setup_files_base_url="$setup_files_base_url/src/site/resources/examples/jmibeans-examples-webcert"
