...
import static com.github.codeteapot.jmibeans.testing.shell.TestMachineCommandExecution.execution;
...
class MachineTerminalExecutorTest {
  ...
  @Test
  void executeWithInterrupt() throws Exception {
  ...
  @Test
  void readFromOutput() throws Exception {
  ...
  @Test
  void readFromError() throws Exception {
    ByteArrayOutputStream bytes = new ByteArrayOutputStream();
    MachineTerminalExecutionResult<byte[]> result = executor.execute(
        context -> {
          try {
  ...
  @Test
  void writeToInput() throws Exception {
    ByteArrayOutputStream bytes = new ByteArrayOutputStream();
    executor.execute(
        context -> {
          try {
