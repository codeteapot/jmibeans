...
class MachineShellClientContextTestOld {
  ...
  void init(@Mock CallbackHandler callbackHandler, @TempDir File configDir) throws Exception {
    ...
    engine = new JSchMachineShellClientEngine(callbackHandler);
    knownIdentity = new JSchKeyPairIdentity(engine, KNOWN_IDENTITY_NAME, RSA, 1024);
    unknownIdentity = new JSchKeyPairIdentity(engine, UNKNOWN_IDENTITY_NAME, RSA, 1024);
