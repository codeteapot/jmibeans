...
class MachineShellAuthentication {
  ...
  MachineShellAuthentication(
      Function<String, MachineShellUser> userGetter,
      Function<MachineShellPasswordName, char[]> passwordGetter) {
    this(changeStepAction -> initial(changeStepAction, userGetter, passwordGetter));
  }
  ...
  private static MachineShellAuthenticationStep initial(
    ...
    return new MachineShellAuthenticationInitialStep(new MachineShellAuthenticationStepChanger(
        ...
        MachineShellAuthenticationUnknownUserStep::new), userGetter, passwordGetter);
  }
}
