...
public interface MachineAgent {
   ...
   *
   * <p>
   * There should not be more than one network with the same name.
   *
   * <p>
   * The value of this property may change. This is reflected by a {@link PropertyChangeEvent} for
   * the {@code networks} property.
   *
