...
class MachineContainer implements PlatformContext {
  ...
  MachineContainer(
    ...
    this(
        new MachineContainerBuilderPropertyConverters(),
        eventTarget,
        catalog,
        builderExecutor,
  ...
  MachineContainer(
    ...
    catalog.registerBuilderPropertyConverters(builderPropertyConverters);
  }
  ...
  private Consumer<MachineContainerProfileSpecs> withProfile(MachineProfile profile) {
    return specs -> machineMap.computeIfAbsent(specs.ref, newRef -> machineConstructor.construct(
        ...
        eventTarget,
        specs.agent,
        buildingJobConstructor.construct(
            builderPropertyConverters,
            builderExecutor,
            specs.builderProperties,
            profile.getBuilder())));
  }
